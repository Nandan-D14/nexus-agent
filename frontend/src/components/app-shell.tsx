...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Remove local isSettingsOpen state as it's now in SettingsContext
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden text-foreground">
      ...
      <button
        ...
        className={`fixed top-4 left-4 z-50 p-2 rounded-xl bg-white/80 dark:bg-card/80 backdrop-blur-xl border border-zinc-200 dark:border-card-border text-zinc-600 dark:text-muted-foreground md:hidden shadow-lg`}
      >
      ...
      >
        ...
        <div className={`p-4 flex items-center ${isCollapsed ? "justify-center" : "justify-between"} mt-1`}>
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-muted-foreground hover:bg-zinc-200/50 dark:hover:bg-muted/50 transition-colors"
          >
        ...
        <div className="px-3 mt-2 space-y-1">
          <button
            ...
            className={`w-full flex items-center gap-3 transition-all duration-200 rounded-lg ${
              isCollapsed 
                ? "justify-center p-2.5 bg-zinc-900 dark:bg-muted/50 text-white dark:text-foreground" 
                : "px-3 py-2 bg-zinc-900 dark:bg-muted/50 text-white dark:text-foreground border border-zinc-800/50 shadow-sm"
            }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 transition-all duration-200 rounded-lg text-muted-foreground hover:bg-zinc-200/50 dark:hover:bg-muted/50 hover:text-foreground ${
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 rounded-lg transition-all duration-200 ${
                    ...
                    isSettingsOpen
                      ? "bg-zinc-200/50 dark:bg-muted/50 text-foreground font-medium"
                      : "text-muted-foreground hover:bg-zinc-200/30 dark:hover:bg-muted/50 hover:text-foreground"
                  }`}
        ...
        <div className="mt-auto p-3 border-t border-sidebar-border">
          {!isCollapsed && quota && (
             <div className="mb-4 px-3 py-2 rounded-lg bg-zinc-200/30 dark:bg-muted/30 border border-black/5 dark:border-card-border">
