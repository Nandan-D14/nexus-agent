...
const FILE_ICONS: Record<FileKind, string> = {
  document: "/ai-chat/plugin-documents.svg",
  spreadsheet: "/ai-chat/plugin-spreadsheets.svg",
  video: "/ai-chat/plugin-videos.svg",
};
...
function StoredFileIcon({ kind }: { kind: FileKind }) {
  ...
  return <img src={FILE_ICONS[kind]} alt="" className="size-6 shrink-0 object-contain" />;
}
