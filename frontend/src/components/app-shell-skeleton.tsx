...
export function AppShellSkeleton() {
  return (
    <div
      className="flex h-screen supports-[height:100dvh]:h-[100dvh] min-h-screen bg-white dark:bg-[#0d0d0d] overflow-hidden text-foreground"
      aria-busy="true"
      aria-label="Loading"
    >
      {/* Sidebar placeholder — expanded desktop width */}
      <aside className="hidden md:flex sticky top-3 m-3 h-[calc(100dvh-24px)] w-[260px] shrink-0 flex-col gap-3 overflow-hidden rounded-xl border border-border-button-white bg-background-secondary-default p-3 shadow-sidebar">
