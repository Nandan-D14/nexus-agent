...
from nexus.skills import build_agent_skills_update, list_agent_skills
    ...
    return [
        {
            ...
            "task_id": getattr(session, "task_id", session.id),
...
async def create_skill(
    ...
    from nexus.skills import _custom_skill
...
async def update_skill(
    ...
    updated_custom = []
    updated = None
    from nexus.skills import _custom_skill, _now_iso
...
@app.delete("/api/v1/skills/{skill_id}", response_model=StatusMessage)
